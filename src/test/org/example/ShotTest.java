...
//    List<Ship> shipListPlayer1 = new ArrayList<>();
//
...
//
//    //Grid
//    String[][] grid1 = new Grid().getGrid(Main.rows +1, Main.columns +1);
//    String[][] grid2 = new Grid().getGrid(Main.rows +1, Main.columns +1);
//
//    assertArrayEquals(coordinates, new Shot().shot(grid1, grid2,shipListPlayer1,shipListPlayer2););
}
